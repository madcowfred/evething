...
EVEthing.home.EventDisplay = function(text, issued) {
    this.issued = Math.round(new Date(issued).getTime() / 1000);
...
EVEthing.home.CharacterDisplay.prototype.parseResponse = function(data) {
    ...
    if (this.character.hasOwnProperty('skill_queue')) {
        for (var i=0; i<this.character.skill_queue.length; i++) {
            ...
            this.character.skill_queue[i].end_time = Math.round(new Date(this.character.skill_queue[i].end_time).getTime() / 1000);
            this.character.skill_queue[i].start_time = Math.round(new Date(this.character.skill_queue[i].start_time).getTime() / 1000);
        }
    ...
    if (this.character.apikey.expires)
        this.character.apikey.expires= Math.round(new Date(this.character.apikey.expires).getTime() / 1000);
    if (this.character.apikey.paid_until)
        this.character.apikey.paid_until = Math.round(new Date(this.character.apikey.paid_until).getTime() / 1000);    
