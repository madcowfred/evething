...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.home_highlight_notifications'
        db.delete_column(u'thing_userprofile', 'home_highlight_notifications')

        # Deleting field 'UserProfile.home_highlight_no_notifications'
        db.delete_column(u'thing_userprofile', 'home_highlight_no_notifications')

        # Adding field 'UserProfile.home_show_borders'
        db.add_column(u'thing_userprofile', 'home_show_borders',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.home_highlight_notifications'
        db.add_column(u'thing_userprofile', 'home_highlight_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.home_highlight_no_notifications'
        db.add_column(u'thing_userprofile', 'home_highlight_no_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'UserProfile.home_show_borders'
        db.delete_column(u'thing_userprofile', 'home_show_borders')
    ...
    models = {
        ...
        u'thing.userprofile': {
            ...
            'home_show_borders': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
