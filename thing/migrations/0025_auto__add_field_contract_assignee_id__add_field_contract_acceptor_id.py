...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.assignee_id'
        db.add_column('thing_contract', 'assignee_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contract.acceptor_id'
        db.add_column('thing_contract', 'acceptor_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.assignee_id'
        db.delete_column('thing_contract', 'assignee_id')

        # Deleting field 'Contract.acceptor_id'
        db.delete_column('thing_contract', 'acceptor_id')
