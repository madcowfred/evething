...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_clock'
        db.add_column('thing_userprofile', 'show_clock',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.show_assets'
        db.add_column('thing_userprofile', 'show_assets',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.show_blueprints'
        db.add_column('thing_userprofile', 'show_blueprints',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.show_contracts'
        db.add_column('thing_userprofile', 'show_contracts',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.show_orders'
        db.add_column('thing_userprofile', 'show_orders',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.show_trade'
        db.add_column('thing_userprofile', 'show_trade',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.show_transactions'
        db.add_column('thing_userprofile', 'show_transactions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.show_market_scan'
        db.add_column('thing_userprofile', 'show_market_scan',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_clock'
        db.delete_column('thing_userprofile', 'show_clock')

        # Deleting field 'UserProfile.show_assets'
        db.delete_column('thing_userprofile', 'show_assets')

        # Deleting field 'UserProfile.show_blueprints'
        db.delete_column('thing_userprofile', 'show_blueprints')

        # Deleting field 'UserProfile.show_contracts'
        db.delete_column('thing_userprofile', 'show_contracts')

        # Deleting field 'UserProfile.show_orders'
        db.delete_column('thing_userprofile', 'show_orders')

        # Deleting field 'UserProfile.show_trade'
        db.delete_column('thing_userprofile', 'show_trade')

        # Deleting field 'UserProfile.show_transactions'
        db.delete_column('thing_userprofile', 'show_transactions')

        # Deleting field 'UserProfile.show_market_scan'
        db.delete_column('thing_userprofile', 'show_market_scan')
