...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CharacterConfig.show_standings'
        db.add_column('thing_characterconfig', 'show_standings',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CharacterConfig.show_standings'
        db.delete_column('thing_characterconfig', 'show_standings')
