...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndustryJob'
        db.create_table('thing_industryjob', (
            ...
            ('assembly_line_id', self.gf('django.db.models.fields.IntegerField')()),
            ('container_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('location_id', self.gf('django.db.models.fields.IntegerField')()),
            ('item_productivity_level', self.gf('django.db.models.fields.IntegerField')()),
            ('item_material_level', self.gf('django.db.models.fields.IntegerField')()),
            ('output_location_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('installer_id', self.gf('django.db.models.fields.IntegerField')()),
            ('runs', self.gf('django.db.models.fields.IntegerField')()),
            ('licensed_production_runs_remaining', self.gf('django.db.models.fields.IntegerField')()),
            ('licensed_production_runs', self.gf('django.db.models.fields.IntegerField')()),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.System'])),
            ('container_location_id', self.gf('django.db.models.fields.IntegerField')()),
            ('material_multiplier', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3)),
            ('character_material_multiplier', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3)),
            ('time_multiplier', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3)),
            ('character_time_multiplier', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3)),
            ('installed_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_installed_items', to=orm['thing.Item'])),
            ('installed_flag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_installed_flags', to=orm['thing.InventoryFlag'])),
            ('output_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_output_items', to=orm['thing.Item'])),
            ('output_flag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_output_flags', to=orm['thing.InventoryFlag'])),
            ('completed', self.gf('django.db.models.fields.IntegerField')()),
            ('completed_status', self.gf('django.db.models.fields.IntegerField')()),
            ('activity', self.gf('django.db.models.fields.IntegerField')()),
            ('install_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('begin_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('pause_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('thing', ['IndustryJob'])


    def backwards(self, orm):
        # Deleting model 'IndustryJob'
        db.delete_table('thing_industryjob')
