...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contract.assignee_char'
        db.delete_column('thing_contract', 'assignee_char_id')

        # Deleting field 'Contract.assignee_corp'
        db.delete_column('thing_contract', 'assignee_corp_id')

        # Deleting field 'Contract.assignee_alliance'
        db.delete_column('thing_contract', 'assignee_alliance_id')

        # Deleting field 'Contract.acceptor_corp'
        db.delete_column('thing_contract', 'acceptor_corp_id')

        # Deleting field 'Contract.acceptor_char'
        db.delete_column('thing_contract', 'acceptor_char_id')


    def backwards(self, orm):
        # Adding field 'Contract.assignee_char'
        db.add_column('thing_contract', 'assignee_char',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_assignees', null=True, to=orm['thing.SimpleCharacter'], blank=True),
                      keep_default=False)

        # Adding field 'Contract.assignee_corp'
        db.add_column('thing_contract', 'assignee_corp',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_assignees', null=True, to=orm['thing.Corporation'], blank=True),
                      keep_default=False)

        # Adding field 'Contract.assignee_alliance'
        db.add_column('thing_contract', 'assignee_alliance',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_assignees', null=True, to=orm['thing.Alliance'], blank=True),
                      keep_default=False)

        # Adding field 'Contract.acceptor_corp'
        db.add_column('thing_contract', 'acceptor_corp',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_acceptors', null=True, to=orm['thing.Corporation'], blank=True),
                      keep_default=False)

        # Adding field 'Contract.acceptor_char'
        db.add_column('thing_contract', 'acceptor_char',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_acceptors', null=True, to=orm['thing.SimpleCharacter'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'thing.userprofile': {
            ...
            'icon_theme': ('django.db.models.fields.CharField', [], {'default': "'icons-default'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
