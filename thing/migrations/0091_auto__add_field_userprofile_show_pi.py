...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_pi'
        db.add_column(u'thing_userprofile', 'show_pi',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_pi'
        db.delete_column(u'thing_userprofile', 'show_pi')
