...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.acceptor_id'
        db.alter_column(u'thing_contract', 'acceptor_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Contract.assignee_id'
        db.alter_column(u'thing_contract', 'assignee_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Station.short_name'
        db.alter_column(u'thing_station', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Corporation.division2'
        db.alter_column(u'thing_corporation', 'division2', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Corporation.division3'
        db.alter_column(u'thing_corporation', 'division3', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Corporation.division1'
        db.alter_column(u'thing_corporation', 'division1', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Corporation.division6'
        db.alter_column(u'thing_corporation', 'division6', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Corporation.division4'
        db.alter_column(u'thing_corporation', 'division4', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Corporation.division5'
        db.alter_column(u'thing_corporation', 'division5', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Corporation.ticker'
        db.alter_column(u'thing_corporation', 'ticker', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Corporation.division7'
        db.alter_column(u'thing_corporation', 'division7', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'CharacterConfig.anon_key'
        db.alter_column(u'thing_characterconfig', 'anon_key', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Asset.name'
        db.alter_column(u'thing_asset', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Contract.acceptor_id'
        db.alter_column(u'thing_contract', 'acceptor_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Contract.assignee_id'
        db.alter_column(u'thing_contract', 'assignee_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Station.short_name'
        db.alter_column(u'thing_station', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Corporation.division2'
        db.alter_column(u'thing_corporation', 'division2', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Corporation.division3'
        db.alter_column(u'thing_corporation', 'division3', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Corporation.division1'
        db.alter_column(u'thing_corporation', 'division1', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Corporation.division6'
        db.alter_column(u'thing_corporation', 'division6', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Corporation.division4'
        db.alter_column(u'thing_corporation', 'division4', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Corporation.division5'
        db.alter_column(u'thing_corporation', 'division5', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Corporation.ticker'
        db.alter_column(u'thing_corporation', 'ticker', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Corporation.division7'
        db.alter_column(u'thing_corporation', 'division7', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
