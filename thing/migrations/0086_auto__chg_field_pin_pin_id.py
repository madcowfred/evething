...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pin.pin_id'
        db.alter_column(u'thing_pin', 'pin_id', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Pin.pin_id'
        db.alter_column(u'thing_pin', 'pin_id', self.gf('django.db.models.fields.IntegerField')())
