...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field characters on 'APIKey'
        db.create_table('thing_apikey_characters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('apikey', models.ForeignKey(orm['thing.apikey'], null=False)),
            ('character', models.ForeignKey(orm['thing.character'], null=False))
        ))
        db.create_unique('thing_apikey_characters', ['apikey_id', 'character_id'])

    def backwards(self, orm):
        # Removing M2M table for field characters on 'APIKey'
        db.delete_table('thing_apikey_characters')
