...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pin.content_amount'
        db.delete_column(u'thing_pin', 'content_amount')

        # Deleting field 'Pin.content'
        db.delete_column(u'thing_pin', 'content_id')


    def backwards(self, orm):
        # Adding field 'Pin.content_amount'
        db.add_column(u'thing_pin', 'content_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Pin.content'
        db.add_column(u'thing_pin', 'content',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['thing.Item'], blank=True),
                      keep_default=False)
