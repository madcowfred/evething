...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkillPlan.mastery_typeid'
        db.add_column(u'thing_skillplan', 'mastery_typeid',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Item'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SkillPlan.mastery_level'
        db.add_column(u'thing_skillplan', 'mastery_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkillPlan.mastery_typeid'
        db.delete_column(u'thing_skillplan', 'mastery_typeid_id')

        # Deleting field 'SkillPlan.mastery_level'
        db.delete_column(u'thing_skillplan', 'mastery_level')
