...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.home_show_separators'
        db.add_column(u'thing_userprofile', 'home_show_separators',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.home_show_separators'
        db.delete_column(u'thing_userprofile', 'home_show_separators')
