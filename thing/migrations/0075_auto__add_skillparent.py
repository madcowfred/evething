...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('thing_skillparent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent_skill', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_skill', to=orm['thing.Skill'])),
            ('child_skill', self.gf('django.db.models.fields.related.ForeignKey')(related_name='child_skill', to=orm['thing.Skill'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('thing_skillparent')
    ...
    models = {
        ...
        'thing.skill': {
            ...
            'parents': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'children'", 'to': "orm['thing.Skill']", 'through': "orm['thing.SkillParent']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        'thing.skillparent': {
            ...
            'child_skill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'child_skill'", 'to': "orm['thing.Skill']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.SmallIntegerField', [], {}),
            'parent_skill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent_skill'", 'to': "orm['thing.Skill']"})
        },
        'thing.skillplan': {
