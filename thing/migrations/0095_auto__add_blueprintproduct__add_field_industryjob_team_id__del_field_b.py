...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlueprintProduct'
        db.create_table(u'thing_blueprintproduct', (
        ...
        db.send_create_signal('thing', ['BlueprintProduct'])

        # Adding field 'IndustryJob.team_id'
        db.add_column(u'thing_industryjob', 'team_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'BlueprintComponent.needs_waste'
        db.delete_column(u'thing_blueprintcomponent', 'needs_waste')

        # Adding field 'BlueprintComponent.activity'
        db.add_column(u'thing_blueprintcomponent', 'activity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'BlueprintComponent.consumed'
        db.add_column(u'thing_blueprintcomponent', 'consumed',
        ...
        # Deleting field 'Blueprint.item'
        db.delete_column(u'thing_blueprint', 'item_id')


    def backwards(self, orm):
        # Deleting model 'BlueprintProduct'
        db.delete_table(u'thing_blueprintproduct')

        # Deleting field 'IndustryJob.team_id'
        db.delete_column(u'thing_industryjob', 'team_id')

        # Adding field 'BlueprintComponent.needs_waste'
        db.add_column(u'thing_blueprintcomponent', 'needs_waste',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'BlueprintComponent.activity'
        db.delete_column(u'thing_blueprintcomponent', 'activity')

        # Deleting field 'BlueprintComponent.consumed'
        db.delete_column(u'thing_blueprintcomponent', 'consumed')
        ...
        # User chose to not deal with backwards NULL issues for 'Blueprint.item'
        raise RuntimeError("Cannot reverse this migration. 'Blueprint.item' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Blueprint.item'
        db.add_column(u'thing_blueprint', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Item']),
                      keep_default=False)
