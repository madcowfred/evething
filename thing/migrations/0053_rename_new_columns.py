...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('thing_contract', 'new_issuer_char_id', 'issuer_char_id')
        db.rename_column('thing_transaction', 'new_other_char_id', 'other_char_id')

    def backwards(self, orm):
        db.rename_column('thing_contract', 'issuer_char_id', 'new_issuer_char_id')
        db.rename_column('thing_transaction', 'other_char_id', 'new_other_char_id')
