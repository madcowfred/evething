...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.entries_per_page'
        db.add_column('thing_userprofile', 'entries_per_page',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.entries_per_page'
        db.delete_column('thing_userprofile', 'entries_per_page')
