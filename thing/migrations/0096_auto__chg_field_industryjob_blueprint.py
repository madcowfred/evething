...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndustryJob.blueprint'
        db.alter_column(u'thing_industryjob', 'blueprint_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Blueprint']))

    def backwards(self, orm):

        # Changing field 'IndustryJob.blueprint'
        db.alter_column(u'thing_industryjob', 'blueprint_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Item']))
