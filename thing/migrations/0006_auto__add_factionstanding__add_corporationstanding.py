...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FactionStanding'
        db.create_table('thing_factionstanding', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('faction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Faction'])),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Character'])),
            ('standing', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
        ))
        db.send_create_signal('thing', ['FactionStanding'])

        # Adding model 'CorporationStanding'
        db.create_table('thing_corporationstanding', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('corporation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Corporation'])),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Character'])),
            ('standing', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
        ))
        db.send_create_signal('thing', ['CorporationStanding'])


    def backwards(self, orm):
        # Deleting model 'FactionStanding'
        db.delete_table('thing_factionstanding')

        # Deleting model 'CorporationStanding'
        db.delete_table('thing_corporationstanding')
    ...
    models = {
        ...
        'thing.corporationstanding': {
            'Meta': {'object_name': 'CorporationStanding'},
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thing.Character']"}),
            'corporation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thing.Corporation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'thing.factionstanding': {
            'Meta': {'object_name': 'FactionStanding'},
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thing.Character']"}),
