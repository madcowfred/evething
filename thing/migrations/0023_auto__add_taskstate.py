...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('thing_taskstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key_info', self.gf('django.db.models.fields.CharField')(max_length=80, db_index=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('parameter', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('mod_time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('next_time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
        ))
        db.send_create_signal('thing', ['TaskState'])


    def backwards(self, orm):
        # Deleting model 'TaskState'
        db.delete_table('thing_taskstate')
