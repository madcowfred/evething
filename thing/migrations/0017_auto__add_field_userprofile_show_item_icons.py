...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_item_icons'
        db.add_column('thing_userprofile', 'show_item_icons',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_item_icons'
        db.delete_column('thing_userprofile', 'show_item_icons')
