...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIKey.needs_apikeyinfo'
        db.add_column(u'thing_apikey', 'needs_apikeyinfo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'APIKey.apikeyinfo_errors'
        db.add_column(u'thing_apikey', 'apikeyinfo_errors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIKey.needs_apikeyinfo'
        db.delete_column(u'thing_apikey', 'needs_apikeyinfo')

        # Deleting field 'APIKey.apikeyinfo_errors'
        db.delete_column(u'thing_apikey', 'apikeyinfo_errors')
