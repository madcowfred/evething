...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndustryJob.product'
        db.alter_column(u'thing_industryjob', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['thing.Item']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'IndustryJob.product'
        raise RuntimeError("Cannot reverse this migration. 'IndustryJob.product' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'IndustryJob.product'
        db.alter_column(u'thing_industryjob', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Item']))
