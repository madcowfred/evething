...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Asset', fields ['asset_id']
        db.create_index(u'thing_asset', ['asset_id'])


        # Changing field 'Asset.parent'
        db.alter_column(u'thing_asset', 'parent', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Asset.corporation_id'
        db.alter_column(u'thing_asset', 'corporation_id', self.gf('django.db.models.fields.IntegerField')())
        ...
        # Changing field 'Asset.system'
        db.alter_column(u'thing_asset', 'system_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['thing.System']))

    def backwards(self, orm):
        # Removing index on 'Asset', fields ['corporation_id']
        db.delete_index(u'thing_asset', ['corporation_id'])

        # Removing index on 'Asset', fields ['asset_id']
        db.delete_index(u'thing_asset', ['asset_id'])


        # Changing field 'Asset.parent'
        db.alter_column(u'thing_asset', 'parent', self.gf('django.db.models.fields.BigIntegerField')(null=True))
        ...
        # Changing field 'Asset.system'
        db.alter_column(u'thing_asset', 'system_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.System'], null=True))
