...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for sc in orm.SimpleCharacter.objects.all():
            char, created = orm.Character.objects.get_or_create(id=sc.id, name=sc.name)

        orm.Contract.objects.all().update(new_issuer_char=models.F('issuer_char'))
        orm.Transaction.objects.all().update(new_other_char=models.F('other_char'))
