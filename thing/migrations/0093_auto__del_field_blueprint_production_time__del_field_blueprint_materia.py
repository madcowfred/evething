...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Blueprint.material_modifier'
        db.delete_column(u'thing_blueprint', 'material_modifier')

        # Deleting field 'Blueprint.waste_factor'
        db.delete_column(u'thing_blueprint', 'waste_factor')

        # Deleting field 'Blueprint.productivity_modifier'
        db.delete_column(u'thing_blueprint', 'productivity_modifier')

        # Adding field 'Blueprint.productionLimit'
        db.add_column(u'thing_blueprint', 'productionLimit',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Blueprint.production_time'
        raise RuntimeError("Cannot reverse this migration. 'Blueprint.production_time' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Blueprint.production_time'
        db.add_column(u'thing_blueprint', 'production_time',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Blueprint.material_modifier'
        raise RuntimeError("Cannot reverse this migration. 'Blueprint.material_modifier' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Blueprint.material_modifier'
        db.add_column(u'thing_blueprint', 'material_modifier',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Blueprint.waste_factor'
        raise RuntimeError("Cannot reverse this migration. 'Blueprint.waste_factor' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Blueprint.waste_factor'
        db.add_column(u'thing_blueprint', 'waste_factor',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Blueprint.productivity_modifier'
        raise RuntimeError("Cannot reverse this migration. 'Blueprint.productivity_modifier' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Blueprint.productivity_modifier'
        db.add_column(u'thing_blueprint', 'productivity_modifier',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'Blueprint.productionLimit'
        db.delete_column(u'thing_blueprint', 'productionLimit')
