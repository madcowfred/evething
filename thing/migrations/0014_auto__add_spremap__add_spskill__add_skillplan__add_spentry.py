...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SPRemap'
        db.create_table('thing_spremap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('int_stat', self.gf('django.db.models.fields.IntegerField')()),
            ('mem_stat', self.gf('django.db.models.fields.IntegerField')()),
            ('per_stat', self.gf('django.db.models.fields.IntegerField')()),
            ('wil_stat', self.gf('django.db.models.fields.IntegerField')()),
            ('cha_stat', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('thing', ['SPRemap'])

        # Adding model 'SPSkill'
        db.create_table('thing_spskill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Skill'])),
            ('level', self.gf('django.db.models.fields.IntegerField')()),
            ('priority', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('thing', ['SPSkill'])

        # Adding model 'SkillPlan'
        db.create_table('thing_skillplan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('is_public', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('thing', ['SkillPlan'])

        # Adding model 'SPEntry'
        db.create_table('thing_spentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('skill_plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['thing.SkillPlan'])),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
            ('sp_remap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.SPRemap'], null=True, blank=True)),
            ('sp_skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.SPSkill'], null=True, blank=True)),
        ))
        db.send_create_signal('thing', ['SPEntry'])


    def backwards(self, orm):
        # Deleting model 'SPRemap'
        db.delete_table('thing_spremap')

        # Deleting model 'SPSkill'
        db.delete_table('thing_spskill')

        # Deleting model 'SkillPlan'
        db.delete_table('thing_skillplan')

        # Deleting model 'SPEntry'
        db.delete_table('thing_spentry')
