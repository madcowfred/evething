...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.home_show_locations'
        db.add_column('thing_userprofile', 'home_show_locations',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.home_show_locations'
        db.delete_column('thing_userprofile', 'home_show_locations')
