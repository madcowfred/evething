...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for contract in orm.Contract.objects.all():
            contract.assignee_id = contract.assignee_char_id or contract.assignee_corp_id or contract.assignee_alliance_id
            contract.acceptor_id = contract.acceptor_char_id or contract.acceptor_corp_id
            contract.save()
