...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('thing_character', 'apikey_id')


    def backwards(self, orm):
        # Adding field 'Character.apikey'
        db.add_column('thing_character', 'apikey',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.APIKey'], null=True, blank=True),
                      keep_default=False)
