...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Implant'
        db.create_table(u'thing_implant', (
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['thing.Item'], unique=True, primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('charisma_modifier', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('intelligence_modifier', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('memory_modifier', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('perception_modifier', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('willpower_modifier', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('implant_slot', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal('thing', ['Implant'])


    def backwards(self, orm):
        # Deleting model 'Implant'
        db.delete_table(u'thing_implant')
