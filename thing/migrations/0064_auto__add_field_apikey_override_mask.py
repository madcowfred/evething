...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIKey.override_mask'
        db.add_column(u'thing_apikey', 'override_mask',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIKey.override_mask'
        db.delete_column(u'thing_apikey', 'override_mask')
