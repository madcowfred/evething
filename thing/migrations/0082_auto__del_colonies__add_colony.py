...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Colonies'
        db.delete_table(u'thing_colonies')

        # Adding model 'Colony'
        db.create_table(u'thing_colony', (
            ...
            ('planet_id', self.gf('django.db.models.fields.IntegerField')()),
            ('planet', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('planet_type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('last_update', self.gf('django.db.models.fields.DateTimeField')()),
            ('level', self.gf('django.db.models.fields.IntegerField')()),
            ('pins', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('thing', ['Colony'])


    def backwards(self, orm):
        # Adding model 'Colonies'
        db.create_table(u'thing_colonies', (
            ('planet', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.System'])),
            ('level', self.gf('django.db.models.fields.IntegerField')()),
            ('pins', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('thing', ['Colonies'])

        # Deleting model 'Colony'
        db.delete_table(u'thing_colony')
