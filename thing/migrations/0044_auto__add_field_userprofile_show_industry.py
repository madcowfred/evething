...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_industry'
        db.add_column('thing_userprofile', 'show_industry',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_industry'
        db.delete_column('thing_userprofile', 'show_industry')
