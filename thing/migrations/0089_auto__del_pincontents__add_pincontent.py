...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PinContents'
        db.delete_table(u'thing_pincontents')

        # Adding model 'PinContent'
        db.create_table(u'thing_pincontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Pin'])),
        ...
        db.send_create_signal('thing', ['PinContent'])


    def backwards(self, orm):
        # Adding model 'PinContents'
        db.create_table(u'thing_pincontents', (
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['thing.Item'])),
            ('content_amount', self.gf('django.db.models.fields.IntegerField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Pin'])),
        ))
        db.send_create_signal('thing', ['PinContents'])

        # Deleting model 'PinContent'
        db.delete_table(u'thing_pincontent')
