...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('thing_contract', (
            ('issuer_char', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_issuers', null=True, to=orm['thing.Character'], blank=True)),
            ('for_corp', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('end_station', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_ends', null=True, to=orm['thing.Station'], blank=True)),
            ...
            ('start_station', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_starts', null=True, to=orm['thing.Station'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
