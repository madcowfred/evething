...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.retrieved_items'
        db.add_column('thing_contract', 'retrieved_items',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Contract.retrieved_items'
        db.delete_column('thing_contract', 'retrieved_items')
