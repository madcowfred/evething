...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CharacterConfig.home_suppress_implants'
        db.add_column(u'thing_characterconfig', 'home_suppress_implants',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CharacterConfig.home_suppress_empty_skill_queue'
        db.add_column(u'thing_characterconfig', 'home_suppress_empty_skill_queue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CharacterConfig.home_suppress_low_skill_queue'
        db.add_column(u'thing_characterconfig', 'home_suppress_low_skill_queue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CharacterConfig.home_suppress_no_game_time'
        db.add_column(u'thing_characterconfig', 'home_suppress_no_game_time',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CharacterConfig.home_suppress_low_game_time'
        db.add_column(u'thing_characterconfig', 'home_suppress_low_game_time',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CharacterConfig.home_suppress_implants'
        db.delete_column(u'thing_characterconfig', 'home_suppress_implants')

        # Deleting field 'CharacterConfig.home_suppress_empty_skill_queue'
        db.delete_column(u'thing_characterconfig', 'home_suppress_empty_skill_queue')

        # Deleting field 'CharacterConfig.home_suppress_low_skill_queue'
        db.delete_column(u'thing_characterconfig', 'home_suppress_low_skill_queue')

        # Deleting field 'CharacterConfig.home_suppress_no_game_time'
        db.delete_column(u'thing_characterconfig', 'home_suppress_no_game_time')

        # Deleting field 'CharacterConfig.home_suppress_low_game_time'
        db.delete_column(u'thing_characterconfig', 'home_suppress_low_game_time')
    ...
    models = {
        ...
        'thing.characterconfig': {
            ...
            'home_group': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64'}),
            'home_suppress_empty_skill_queue': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'home_suppress_implants': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'home_suppress_low_game_time': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'home_suppress_low_skill_queue': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'home_suppress_no_game_time': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
