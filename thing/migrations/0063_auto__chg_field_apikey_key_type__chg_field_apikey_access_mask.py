...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APIKey.key_type'
        db.alter_column(u'thing_apikey', 'key_type', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'APIKey.access_mask'
        db.alter_column(u'thing_apikey', 'access_mask', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'APIKey.key_type'
        db.alter_column(u'thing_apikey', 'key_type', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'APIKey.access_mask'
        db.alter_column(u'thing_apikey', 'access_mask', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    ...
    models = {
        ...
        u'thing.apikey': {
            ...
            'access_mask': ('django.db.models.fields.BigIntegerField', [], {'default': '-1'}),
