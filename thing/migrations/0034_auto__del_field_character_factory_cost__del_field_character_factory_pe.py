...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Character.factory_cost'
        db.delete_column('thing_character', 'factory_cost')

        # Deleting field 'Character.factory_per_hour'
        db.delete_column('thing_character', 'factory_per_hour')

        # Deleting field 'Character.sales_tax'
        db.delete_column('thing_character', 'sales_tax')

        # Deleting field 'Character.brokers_fee'
        db.delete_column('thing_character', 'brokers_fee')


    def backwards(self, orm):
        # Adding field 'Character.factory_cost'
        db.add_column('thing_character', 'factory_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Character.factory_per_hour'
        db.add_column('thing_character', 'factory_per_hour',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Character.sales_tax'
        db.add_column('thing_character', 'sales_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=1.5, max_digits=3, decimal_places=2),
                      keep_default=False)

        # Adding field 'Character.brokers_fee'
        db.add_column('thing_character', 'brokers_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=3, decimal_places=2),
                      keep_default=False)
