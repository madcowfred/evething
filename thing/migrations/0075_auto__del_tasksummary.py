...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TaskSummary'
        db.delete_table(u'thing_tasksummary')


    def backwards(self, orm):
        # Adding model 'TaskSummary'
        db.create_table(u'thing_tasksummary', (
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ymdh', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
        ))
        db.send_create_signal(u'thing', ['TaskSummary'])
