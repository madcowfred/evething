...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.new_other_char'
        db.add_column('thing_transaction', 'new_other_char',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='temp', null=True, to=orm['thing.Character']),
                      keep_default=False)

        # Adding field 'Contract.new_issuer_char'
        db.add_column('thing_contract', 'new_issuer_char',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Character'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.new_other_char'
        db.delete_column('thing_transaction', 'new_other_char_id')

        # Deleting field 'Contract.new_issuer_char'
        db.delete_column('thing_contract', 'new_issuer_char_id')
    ...
    models = {
        ...
        'thing.contract': {
            ...
            'new_issuer_char': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thing.Character']", 'null': 'True', 'blank': 'True'}),
        ...
        'thing.transaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thing.Item']"}),
            'new_other_char': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'temp'", 'null': 'True', 'to': "orm['thing.Character']"}),
