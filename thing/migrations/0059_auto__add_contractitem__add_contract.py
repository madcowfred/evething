...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('thing_contractitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_items', to=orm['thing.Item'])),
            ...
            ('included', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('thing', ['ContractItem'])
        ...
        db.create_table('thing_contract', (
            ...
            ('contract_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('issuer_char', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contract_issuers', null=True, to=orm['thing.Character'])),
            ...
            ('acceptor_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('retrieved_items', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('thing_contractitem')
    ...
    models = {
        ...
        'thing.contract': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issuer_char': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'contract_issuers'", 'null': 'True', 'to': "orm['thing.Character']"}),
