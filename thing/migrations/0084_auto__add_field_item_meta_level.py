...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.meta_level'
        db.add_column(u'thing_item', 'meta_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.meta_level'
        db.delete_column(u'thing_item', 'meta_level')
    ...
    models = {
        ...
        'thing.item': {
            ...
            'meta_level': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'thing.itemprerequisite': {
            'Meta': {'object_name': 'ItemPrerequisite'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prereq_skill'", 'to': "orm['thing.Item']"}),
            'level': ('django.db.models.fields.SmallIntegerField', [], {}),
            'skill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'required_for_item'", 'to': "orm['thing.Skill']"})
        },
        'thing.journalentry': {
