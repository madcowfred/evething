...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Fix up Station.short_name
        db.execute("UPDATE thing_station SET short_name = '' WHERE short_name IS NULL");

        # Fix up Corporation stuff
        db.execute("UPDATE thing_corporation SET division1 = '' WHERE division1 IS NULL");
        db.execute("UPDATE thing_corporation SET division2 = '' WHERE division2 IS NULL");
        db.execute("UPDATE thing_corporation SET division3 = '' WHERE division3 IS NULL");
        db.execute("UPDATE thing_corporation SET division4 = '' WHERE division4 IS NULL");
        db.execute("UPDATE thing_corporation SET division5 = '' WHERE division5 IS NULL");
        db.execute("UPDATE thing_corporation SET division6 = '' WHERE division6 IS NULL");
        db.execute("UPDATE thing_corporation SET division7 = '' WHERE division7 IS NULL");
        db.execute("UPDATE thing_corporation SET ticker = '' WHERE ticker IS NULL");
