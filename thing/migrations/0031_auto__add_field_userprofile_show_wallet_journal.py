...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_wallet_journal'
        db.add_column('thing_userprofile', 'show_wallet_journal',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_wallet_journal'
        db.delete_column('thing_userprofile', 'show_wallet_journal')
