...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.home_highlight_backgrounds'
        db.add_column(u'thing_userprofile', 'home_highlight_backgrounds',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.home_highlight_borders'
        db.add_column(u'thing_userprofile', 'home_highlight_borders',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.home_highlight_backgrounds'
        db.delete_column(u'thing_userprofile', 'home_highlight_backgrounds')

        # Deleting field 'UserProfile.home_highlight_borders'
        db.delete_column(u'thing_userprofile', 'home_highlight_borders')
