...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SimpleCharacter'
        db.create_table('thing_simplecharacter', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('thing', ['SimpleCharacter'])
        ...
        # Adding field 'Transaction.other_corp'
        db.add_column('thing_transaction', 'other_corp',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Corporation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SimpleCharacter'
        db.delete_table('thing_simplecharacter')

        # Deleting field 'Transaction.other_char'
        db.delete_column('thing_transaction', 'other_char_id')

        # Deleting field 'Transaction.other_corp'
        db.delete_column('thing_transaction', 'other_corp_id')
