...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.other_char'
        db.delete_column('thing_transaction', 'other_char_id')

        # Deleting field 'Contract.issuer_char'
        db.delete_column('thing_contract', 'issuer_char_id')


    def backwards(self, orm):
        # Adding field 'Transaction.other_char'
        db.add_column('thing_transaction', 'other_char',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.SimpleCharacter'], null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Contract.issuer_char'
        raise RuntimeError("Cannot reverse this migration. 'Contract.issuer_char' and its values cannot be restored.")
    ...
    models = {
        ...
        'thing.contract': {
            ...
            'new_issuer_char': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'contract_issuers'", 'null': 'True', 'to': "orm['thing.Character']"}),
        ...
        'thing.transaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['thing.Item']"}),
            'new_other_char': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'transaction_others'", 'null': 'True', 'to': "orm['thing.Character']"}),
