...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CharacterConfig.home_group'
        db.add_column(u'thing_characterconfig', 'home_group',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CharacterConfig.home_group'
        db.delete_column(u'thing_characterconfig', 'home_group')
