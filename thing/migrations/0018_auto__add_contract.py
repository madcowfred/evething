...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('thing_contract', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('issuer_char', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_issuers', to=orm['thing.SimpleCharacter'])),
            ('issuer_corp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_issuers', to=orm['thing.Corporation'])),
            ('assignee_char', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contract_assignees', null=True, to=orm['thing.SimpleCharacter'])),
            ('assignee_corp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contract_assignees', null=True, to=orm['thing.Corporation'])),
            ('acceptor_char', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contract_acceptors', null=True, to=orm['thing.SimpleCharacter'])),
            ('acceptor_corp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contract_acceptors', null=True, to=orm['thing.Corporation'])),
            ('start_station', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contract_starts', null=True, to=orm['thing.Station'])),
            ('end_station', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contract_ends', null=True, to=orm['thing.Station'])),
            ...
            ('for_corp', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_issued', self.gf('django.db.models.fields.DateTimeField')()),
            ...
            ('reward', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2)),
            ('collateral', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2)),
            ('buyout', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2)),
            ('volume', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=4)),
        ))
        db.send_create_signal('thing', ['Contract'])


    def backwards(self, orm):
        # Deleting model 'Contract'
        db.delete_table('thing_contract')
