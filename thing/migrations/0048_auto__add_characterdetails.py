...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CharacterDetails'
        db.create_table('thing_characterdetails', (
            ('character', self.gf('django.db.models.fields.related.OneToOneField')(related_name='details', unique=True, primary_key=True, to=orm['thing.Character'])),
            ('wallet_balance', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=18, decimal_places=2)),
            ...
            ('security_status', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=4)),
            ('last_known_location', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('ship_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Item'], null=True, blank=True)),
            ('ship_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
        ))
        db.send_create_signal('thing', ['CharacterDetails'])


    def backwards(self, orm):
        # Deleting model 'CharacterDetails'
        db.delete_table('thing_characterdetails')
