...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Colony', fields ['character', 'planet_id']
        db.create_unique(u'thing_colony', ['character_id', 'planet_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Colony', fields ['character', 'planet_id']
        db.delete_unique(u'thing_colony', ['character_id', 'planet_id'])
