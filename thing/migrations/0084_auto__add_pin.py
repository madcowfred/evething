...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pin'
        db.create_table(u'thing_pin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pin_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('colony', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Colony'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['thing.Item'])),
            ('schematic', self.gf('django.db.models.fields.IntegerField')()),
            ('cycle_time', self.gf('django.db.models.fields.IntegerField')()),
            ('quantity_per_cycle', self.gf('django.db.models.fields.IntegerField')()),
            ('installed', self.gf('django.db.models.fields.DateTimeField')()),
            ('expires', self.gf('django.db.models.fields.DateTimeField')()),
            ('last_launched', self.gf('django.db.models.fields.DateTimeField')()),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['thing.Item'])),
            ('content_amount', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('thing', ['Pin'])


    def backwards(self, orm):
        # Deleting model 'Pin'
        db.delete_table(u'thing_pin')
    ...
    models = {
        ...
        'thing.pin': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['thing.Item']"}),
            'content_amount': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'pin_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
