...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'thing_assetsummary', (
            ...
            ('total_volume', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('total_value', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=2)),
        ))
        db.send_create_signal(u'thing', ['AssetSummary'])


    def backwards(self, orm):
        # Deleting model 'AssetSummary'
        db.delete_table(u'thing_assetsummary')
