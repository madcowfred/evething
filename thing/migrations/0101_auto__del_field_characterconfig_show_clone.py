...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CharacterConfig.show_clone'
        db.delete_column(u'thing_characterconfig', 'show_clone')


    def backwards(self, orm):
        # Adding field 'CharacterConfig.show_clone'
        db.add_column(u'thing_characterconfig', 'show_clone',
