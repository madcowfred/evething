...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.icon_theme'
        db.add_column('thing_userprofile', 'icon_theme',
                      self.gf('django.db.models.fields.CharField')(default='icons-default', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.icon_theme'
        db.delete_column('thing_userprofile', 'icon_theme')
