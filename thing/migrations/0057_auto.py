...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'JournalEntry', fields ['ref_id']
        db.create_index('thing_journalentry', ['ref_id'])


    def backwards(self, orm):
        # Removing index on 'JournalEntry', fields ['ref_id']
        db.delete_index('thing_journalentry', ['ref_id'])
