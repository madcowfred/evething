...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.home_sort_order'
        db.add_column('thing_userprofile', 'home_sort_order',
                      self.gf('django.db.models.fields.CharField')(default='apiname', max_length=12),
                      keep_default=False)

        # Adding field 'UserProfile.home_sort_descending'
        db.add_column('thing_userprofile', 'home_sort_descending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.home_sort_order'
        db.delete_column('thing_userprofile', 'home_sort_order')

        # Deleting field 'UserProfile.home_sort_descending'
        db.delete_column('thing_userprofile', 'home_sort_descending')
