...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APIKeyFailure'
        db.create_table('thing_apikeyfailure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('keyid', self.gf('django.db.models.fields.IntegerField')()),
            ('fail_time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('fail_reason', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('thing', ['APIKeyFailure'])


    def backwards(self, orm):
        # Deleting model 'APIKeyFailure'
        db.delete_table('thing_apikeyfailure')
