...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('thing_alliance', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal('thing', ['Alliance'])

        # Adding field 'Corporation.alliance'
        db.add_column('thing_corporation', 'alliance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Alliance'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Alliance'
        db.delete_table('thing_alliance')

        # Deleting field 'Corporation.alliance'
        db.delete_column('thing_corporation', 'alliance_id')
