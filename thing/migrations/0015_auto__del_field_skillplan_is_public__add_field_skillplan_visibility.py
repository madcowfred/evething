...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SkillPlan.is_public'
        db.delete_column('thing_skillplan', 'is_public')

        # Adding field 'SkillPlan.visibility'
        db.add_column('thing_skillplan', 'visibility',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SkillPlan.is_public'
        db.add_column('thing_skillplan', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SkillPlan.visibility'
        db.delete_column('thing_skillplan', 'visibility')
