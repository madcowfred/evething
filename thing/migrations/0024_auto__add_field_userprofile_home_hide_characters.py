...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.home_hide_characters'
        db.add_column('thing_userprofile', 'home_hide_characters',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.home_hide_characters'
        db.delete_column('thing_userprofile', 'home_hide_characters')
