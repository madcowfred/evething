...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIKey.corporation'
        db.add_column(u'thing_apikey', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Corporation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIKey.corporation'
        db.delete_column(u'thing_apikey', 'corporation_id')
