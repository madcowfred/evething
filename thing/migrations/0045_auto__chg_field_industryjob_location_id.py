...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndustryJob.location_id'
        db.alter_column('thing_industryjob', 'location_id', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'IndustryJob.location_id'
        db.alter_column('thing_industryjob', 'location_id', self.gf('django.db.models.fields.IntegerField')())
