...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pin.content'
        db.alter_column(u'thing_pin', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['thing.Item']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Pin.content'
        raise RuntimeError("Cannot reverse this migration. 'Pin.content' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Pin.content'
        db.alter_column(u'thing_pin', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Item']))
    ...
    models = {
        ...
        'thing.pin': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['thing.Item']"}),
            'content_amount': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
