...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CharacterDetails.cha_bonus'
        db.delete_column(u'thing_characterdetails', 'cha_bonus')

        # Deleting field 'CharacterDetails.mem_bonus'
        db.delete_column(u'thing_characterdetails', 'mem_bonus')

        # Deleting field 'CharacterDetails.int_bonus'
        db.delete_column(u'thing_characterdetails', 'int_bonus')

        # Deleting field 'CharacterDetails.per_bonus'
        db.delete_column(u'thing_characterdetails', 'per_bonus')

        # Deleting field 'CharacterDetails.wil_bonus'
        db.delete_column(u'thing_characterdetails', 'wil_bonus')

        # Adding M2M table for field implants on 'CharacterDetails'
        m2m_table_name = db.shorten_name(u'thing_characterdetails_implants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('characterdetails', models.ForeignKey(orm['thing.characterdetails'], null=False)),
            ('implant', models.ForeignKey(orm['thing.implant'], null=False))
        ))
        db.create_unique(m2m_table_name, ['characterdetails_id', 'implant_id'])


    def backwards(self, orm):
        # Adding field 'CharacterDetails.cha_bonus'
        db.add_column(u'thing_characterdetails', 'cha_bonus',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CharacterDetails.mem_bonus'
        db.add_column(u'thing_characterdetails', 'mem_bonus',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CharacterDetails.int_bonus'
        db.add_column(u'thing_characterdetails', 'int_bonus',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CharacterDetails.per_bonus'
        db.add_column(u'thing_characterdetails', 'per_bonus',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CharacterDetails.wil_bonus'
        db.add_column(u'thing_characterdetails', 'wil_bonus',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Removing M2M table for field implants on 'CharacterDetails'
        db.delete_table(db.shorten_name(u'thing_characterdetails_implants'))
