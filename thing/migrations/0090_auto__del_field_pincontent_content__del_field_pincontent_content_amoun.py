...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PinContent.content'
        db.delete_column(u'thing_pincontent', 'content_id')

        # Deleting field 'PinContent.content_amount'
        db.delete_column(u'thing_pincontent', 'content_amount')

        # Adding field 'PinContent.item'
        db.add_column(u'thing_pincontent', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['thing.Item']),
                      keep_default=False)

        # Adding field 'PinContent.quantity'
        db.add_column(u'thing_pincontent', 'quantity',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PinContent.content'
        raise RuntimeError("Cannot reverse this migration. 'PinContent.content' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PinContent.content'
        db.add_column(u'thing_pincontent', 'content',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['thing.Item']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'PinContent.content_amount'
        raise RuntimeError("Cannot reverse this migration. 'PinContent.content_amount' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PinContent.content_amount'
        db.add_column(u'thing_pincontent', 'content_amount',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'PinContent.item'
        db.delete_column(u'thing_pincontent', 'item_id')

        # Deleting field 'PinContent.quantity'
        db.delete_column(u'thing_pincontent', 'quantity')
