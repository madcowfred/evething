...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Asset.corporation'
        db.delete_column('thing_asset', 'corporation_id')

        # Adding field 'Asset.corporation_id'
        db.add_column('thing_asset', 'corporation_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Asset.corporation'
        db.add_column('thing_asset', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Corporation'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Asset.corporation_id'
        db.delete_column('thing_asset', 'corporation_id')
