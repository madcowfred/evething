...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APICache.error_displayed'
        db.add_column('thing_apicache', 'error_displayed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APICache.error_displayed'
        db.delete_column('thing_apicache', 'error_displayed')
