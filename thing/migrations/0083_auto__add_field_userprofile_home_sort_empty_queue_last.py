...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.home_sort_empty_queue_last'
        db.add_column(u'thing_userprofile', 'home_sort_empty_queue_last',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.home_sort_empty_queue_last'
        db.delete_column(u'thing_userprofile', 'home_sort_empty_queue_last')
    ...
    models = {
        ...
        'thing.userprofile': {
            ...
            'home_sort_empty_queue_last': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
