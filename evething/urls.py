...
urlpatterns += patterns('thing.views',
    ...
    (r'^skillplan/ajax/clean$','skillplan_ajax_clean'),
    (r'^skillplan/ajax/delete/entry$','skillplan_ajax_delete_entry'),
    ...
    (r'^skillplan/ajax/optimize/skillplan$','skillplan_ajax_optimize_skillplan'),
    (r'^skillplan/ajax/optimize/remaps$','skillplan_ajax_optimize_remaps'),
